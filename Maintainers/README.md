...
5. 템플릿에 맞춰 주제 문서를 작성하고 상위 README의 `Status`를 갱신한다.
6. 저장소 루트에서 `python Maintainers/Scripts/validate_docs.py` 또는 `py -3 Maintainers/Scripts/validate_docs.py`로 구조를 검수한다.
